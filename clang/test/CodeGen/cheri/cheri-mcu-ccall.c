...
// CHECK: define dso_local chericcallcce i32 @test2(i32 %a0, i32 %a1) local_unnamed_addr addrspace(200) #0
...
int testcall6()
{
	...
	int args[8];
	// CHECK: call chericcallcc i32 @test6callee
	return test6callee(
			&args[0],
			&args[1],
			&args[2],
...
// CHECK: declare chericcallcc i32 @test6callee(i32 addrspace(200)*, i32 addrspace(200)*, i32 addrspace(200)*, i32 addrspace(200)*, i32 addrspace(200)*, i32 addrspace(200)*) local_unnamed_addr addrspace(200) #3

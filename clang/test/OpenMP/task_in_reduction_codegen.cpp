...
// CHECK-NEXT:    [[TMP4:%.*]] = load i16, ptr [[ARRAYIDX]], align 2
// CHECK-NEXT:    [[CONV:%.*]] = sext i16 [[TMP4]] to i32
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[A]], align 4
// CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP5]], [[CONV]]
// CHECK-NEXT:    store i32 [[ADD]], ptr [[A]], align 4
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[A]], align 4
// CHECK-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP6]], 1
// CHECK-NEXT:    store i32 [[INC]], ptr [[A]], align 4
// CHECK-NEXT:    store i32 0, ptr [[RETVAL]], align 4
// CHECK-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8
// CHECK-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP7]])
// CHECK-NEXT:    [[ARRAY_BEGIN2:%.*]] = getelementptr inbounds [5 x %struct.S], ptr [[C]], i32 0, i32 0
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN2]], i64 5
// CHECK-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK:       arraydestroy.body:
// CHECK-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi ptr [ [[TMP8]], [[ARRAYCTOR_CONT]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ]

...
define dso_local ptr addrspace(200) @assume_variable(ptr addrspace(200) %ptr, i64 %alignment) addrspace(200) #0 {
; CHECK-LABEL: define {{[^@]+}}@assume_variable
; CHECK-SAME: (ptr addrspace(200) [[PTR:%.*]], i64 [[ALIGNMENT:%.*]]) addrspace(200) {
...
define dso_local ptr addrspace(200) @assume_const(ptr addrspace(200) %ptr) addrspace(200) #0 {
; CHECK-LABEL: define {{[^@]+}}@assume_const
; CHECK-SAME: (ptr addrspace(200) [[PTR:%.*]]) addrspace(200) {

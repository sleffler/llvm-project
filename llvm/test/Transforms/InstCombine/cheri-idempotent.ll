...
; INSTCOMBINE-LABEL: @setbounds_idempotent_exact2(
...
;
; INSTSIMPLIFY-LABEL: @setbounds_idempotent_exact2(
...
; Must use exact version when combining
; Can't upgrade inexact to exact when running instsimplify
; INSTCOMBINE-LABEL: @setbounds_idempotent_exact3(
...
;
; INSTSIMPLIFY-LABEL: @setbounds_idempotent_exact3(
; INSTSIMPLIFY-NEXT:    [[FIRST:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) [[PTR:%.*]], i64 [[SIZE:%.*]])
...
; INSTCOMBINE-LABEL: @no_remove_exact(
...
;
; INSTSIMPLIFY-LABEL: @no_remove_exact(
; INSTSIMPLIFY-NEXT:    [[FIRST:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) [[PTR:%.*]], i64 [[SIZE:%.*]])

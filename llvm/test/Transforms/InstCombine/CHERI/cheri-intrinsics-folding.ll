...
define i64 @null_get_offset() addrspace(200) #1 {
...
define i64 @null_get_base() addrspace(200) #1 {
...
define i64 @null_get_address() addrspace(200) #1 {
...
define i64 @null_get_perms() addrspace(200) #1 {
...
define i64 @null_get_flags() addrspace(200) #1 {
...
define i64 @null_get_sealed() addrspace(200) #1 {
...
define i64 @null_get_tag() addrspace(200) #1 {
...
define i64 @null_get_length() addrspace(200) #1 {
...
define i64 @null_get_type() addrspace(200) #1 {
...
define void @infer_values_from_null_set_offset() addrspace(200) #1 {
...
define void @infer_values_from_null_set_address() addrspace(200) #1 {
...
; Function Attrs: nounwind memory(none)
define void @infer_values_from_arg_set_address(ptr addrspace(200) %arg) addrspace(200) #1 {
...
define void @infer_values_from_arg_set_offset(ptr addrspace(200) %arg) addrspace(200) #1 {
...
define i64 @fold_set_offset_arg(ptr addrspace(200) %arg) addrspace(200) #1 {
...
define i64 @no_fold_set_offset_get_address(ptr addrspace(200) %arg) addrspace(200) #1 {
  %with_offset = tail call ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 42)
...
define i64 @fold_set_address_get_address(ptr addrspace(200) %arg) addrspace(200) #1 {
...
define i64 @no_fold_set_offset_get_tag(ptr addrspace(200) %arg) addrspace(200) #1 {
  %with_offset = tail call ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 42)
...
define i64 @fold_null_inc_offset() addrspace(200) #1 {
  %ret = tail call i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 100))
  ret i64 %ret
  ; CHECK-LABEL: @fold_null_inc_offset()
  ; CHECK: ret i64 100
}

define i64 @fold_null_inc_offset_get_address() addrspace(200) #1 {
  %ret = tail call i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 100))
  ret i64 %ret
  ; CHECK-LABEL: @fold_null_inc_offset_get_address()
  ; CHECK: ret i64 100
}

define i64 @fold_null_set_address_get_offset() addrspace(200) #1 {
...
define i64 @fold_null_set_address_offset_get_address() addrspace(200) #1 {
  %setaddr = tail call ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 100)
...
define i64 @fold_base_get_inttoptr() addrspace(200) #1 {
...
define i64 @fold_tag_get_inttoptr() addrspace(200) #1 {
...
define i64 @fold_offset_get_inttoptr() addrspace(200) #1 {
...
define i64 @fold_address_get_inttoptr() addrspace(200) #1 {
...
define i64 @fold_type_get_inttoptr() addrspace(200) #1 {
...
define i64 @fold_length_get_inttoptr() addrspace(200) #1 {
...
define ptr addrspace(200) @fold_set_offset_inc_offset(ptr addrspace(200) %arg) addrspace(200) #1 {
  %with_offset = tail call ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 42)
...
define ptr addrspace(200) @fold_set_inc_gep_sequence() local_unnamed_addr addrspace(200) #1 {
entry:
...
define ptr addrspace(200) @fold_set_addr_inc_gep_sequence() local_unnamed_addr addrspace(200) #1 {
entry:
...
define ptr addrspace(200) @fold_set_inc_gep_sequence_arg(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) #1 {
...
define ptr addrspace(200) @fold_set_addr_inc_gep_sequence_arg(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) #1 {
...
define ptr addrspace(200) @fold_inc_gep_sequence_null() local_unnamed_addr addrspace(200) #1 {
  %gep1 = getelementptr inbounds i8, ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 100), i64 -4
  %gep2 = getelementptr inbounds i8, ptr addrspace(200) %gep1, i64 -4
...
define ptr addrspace(200) @fold_inc_gep_sequence_arg(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) #1 {
...
define ptr addrspace(200) @fold_gep_incoffset(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) #1 {
...
define ptr addrspace(200) @fold_gep_incoffset2(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) #1 {
...
define ptr addrspace(200) @fold_null_setaddr_zero() addrspace(200) #1 {
...
define ptr addrspace(200) @fold_null_setoffest_zero() addrspace(200) #1 {
...
define ptr addrspace(200) @fold_null_incoffset_zero() addrspace(200) #1 {
  %ret = call ptr addrspace(200) @check_fold_i8ptr(ptr addrspace(200) null)
  ret ptr addrspace(200) %ret
...
define ptr addrspace(200) @fold_incoffset_zero(ptr addrspace(200) %arg) addrspace(200) #1 {
...
define ptr addrspace(200) @fold_setoffset_null_zero_to_null() addrspace(200) #1 {
...
define ptr addrspace(200) @fold_setaddr_null_zero_to_null() addrspace(200) #1 {

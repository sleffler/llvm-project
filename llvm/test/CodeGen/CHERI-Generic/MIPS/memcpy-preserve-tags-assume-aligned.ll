...
; CHECK-NEXT:    csc $c1, $zero, 16($c4)
  ...
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) align 1 %align1, ptr addrspace(200) align 16 %1, i64 32, i1 false) must_preserve_cheri_tags
  ret void
}
...
; CHECK-NEXT:    csc $c2, $zero, 0($c4)
  ...
  tail call void @llvm.assume(i1 %maskcond)
  %1 = bitcast ptr addrspace(200) %local_cap_ptr to ptr addrspace(200)
  call void @llvm.memmove.p200.p200.i64(ptr addrspace(200) align 1 %align1, ptr addrspace(200) align 16 %1, i64 32, i1 false) must_preserve_cheri_tags
  ret void
}

...
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[TMP1]], i64 40)
...
;
  ...
  %1 = bitcast ptr addrspace(200) %array to ptr addrspace(200)
  call void @llvm.lifetime.start.p200(i64 40, ptr addrspace(200) nonnull %1)
  %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 40)
  call void @use(ptr addrspace(200) %2)
  %arrayidx = getelementptr inbounds i8, ptr addrspace(200) %2, i64 20
  %3 = bitcast ptr addrspace(200) %arrayidx to ptr addrspace(200)
  %4 = load i32, ptr addrspace(200) %3, align 4
  call void @llvm.lifetime.end.p200(i64 40, ptr addrspace(200) nonnull %1)
  ret i32 %4
}

; DBG-LABEL: Checking function stack_array
; DBG-NEXT: cheri-bound-allocas:  -Checking if bitcast needs stack bounds:   %1 = bitcast ptr addrspace(200) %array to ptr addrspace(200)
; DBG-NEXT: cheri-bound-allocas:   -No need for stack bounds for lifetime_{start,end}:   call void @llvm.lifetime.end.p200(i64 40, ptr addrspace(200) nonnull %1)
; DBG-NEXT: cheri-bound-allocas:   -No need for stack bounds for use in setbounds with smaller or equal size: original size=40, setbounds size=40 current offset=0:  %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 40)
; DBG-NEXT: cheri-bound-allocas:   -No need for stack bounds for lifetime_{start,end}:   call void @llvm.lifetime.start.p200(i64 40, ptr addrspace(200) nonnull %1)
; DBG-NEXT: cheri-bound-allocas:  -no bitcast users need bounds:   %1 = bitcast ptr addrspace(200) %array to ptr addrspace(200)
...
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[TMP1]], i64 4)
; CHECK-NEXT:    call void @use(ptr addrspace(200) [[TMP2]])
...
;
  ...
  %1 = bitcast ptr addrspace(200) %value to ptr addrspace(200)
  call void @llvm.lifetime.start.p200(i64 4, ptr addrspace(200) nonnull %1)
  store i32 1, ptr addrspace(200) %value, align 4
  %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 4)
  call void @use(ptr addrspace(200) %2)
  %3 = load i32, ptr addrspace(200) %value, align 4
  call void @llvm.lifetime.end.p200(i64 4, ptr addrspace(200) nonnull %1)
  ret i32 %3
}

; DBG-LABEL: Checking function stack_int
; DBG-NEXT: cheri-bound-allocas:  -Checking if load/store needs bounds (GEP offset is 0):   %3 = load i32, ptr addrspace(200) %value, align 4
; DBG-NEXT: cheri-bound-allocas:   -Load/store size=4, alloca size=4, current GEP offset=0 for i32
; DBG-NEXT: cheri-bound-allocas:   -Load/store is in bounds -> can reuse $csp for   %3 = load i32, ptr addrspace(200) %value, align 4
...
; DBG-NEXT: cheri-bound-allocas:  -Checking if bitcast needs stack bounds:   %1 = bitcast ptr addrspace(200) %value to ptr addrspace(200)
; DBG-NEXT: cheri-bound-allocas:   -No need for stack bounds for lifetime_{start,end}:   call void @llvm.lifetime.end.p200(i64 4, ptr addrspace(200) nonnull %1)
; DBG-NEXT: cheri-bound-allocas:   -No need for stack bounds for use in setbounds with smaller or equal size: original size=4, setbounds size=4 current offset=0:  %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 4)
; DBG-NEXT: cheri-bound-allocas:   -No need for stack bounds for lifetime_{start,end}:   call void @llvm.lifetime.start.p200(i64 4, ptr addrspace(200) nonnull %1)
; DBG-NEXT: cheri-bound-allocas:  -no bitcast users need bounds:   %1 = bitcast ptr addrspace(200) %value to ptr addrspace(200)
...
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[TMP2]], i64 5)
...
;
  %value = alloca i32, align 4, addrspace(200)
  %1 = bitcast ptr addrspace(200) %value to ptr addrspace(200)
  %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 5)
  %address.with.bounds = bitcast ptr addrspace(200) %2 to ptr addrspace(200)
  store i32 2, ptr addrspace(200) %address.with.bounds, align 4
  %3 = load i32, ptr addrspace(200) %value, align 4
  ret i32 %3
...
; DBG-NEXT: cheri-bound-allocas:   -Load/store is in bounds -> can reuse $csp for   %3 = load i32, ptr addrspace(200) %value, align 4
; DBG-NEXT: cheri-bound-allocas:  -Checking if bitcast needs stack bounds:   %1 = bitcast ptr addrspace(200) %value to ptr addrspace(200)
; DBG-NEXT: cheri-bound-allocas:   -out_of_bounds_setbounds: setbounds use offset OUT OF BOUNDS and will trap -> adding csetbounds:   %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 5)
; DBG-NEXT: cheri-bound-allocas:  -Adding stack bounds since bitcast user needs bounds:   %2 = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull %1, i64 5)
; DBG-NEXT: cheri-bound-allocas: Found alloca use that needs bounds:   %1 = bitcast ptr addrspace(200) %value to ptr addrspace(200)
...
;
  ...
  store i32 1, ptr addrspace(200) %2, align 4
  ret void
}

; DBG-NEXT: Checking function assume_aligned
; DBG-NEXT: cheri-bound-allocas:  -Checking if bitcast needs stack bounds:   %2 = bitcast ptr addrspace(200) %1 to ptr addrspace(200)
; DBG-NEXT: cheri-bound-allocas:   -Checking if load/store needs bounds (GEP offset is 0):   store i32 1, ptr addrspace(200) %2, align 4
; DBG-NEXT: cheri-bound-allocas:    -Load/store size=4, alloca size=4, current GEP offset=0 for i32
; DBG-NEXT: cheri-bound-allocas:    -Load/store is in bounds -> can reuse $csp for   store i32 1, ptr addrspace(200) %2, align 4
; DBG-NEXT: cheri-bound-allocas:  -no bitcast users need bounds:   %2 = bitcast ptr addrspace(200) %1 to ptr addrspace(200)

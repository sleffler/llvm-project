...
; PURECAP-NEXT:    csc $c1, $zero, 0($c3)
; PURECAP-NEXT:    cjr $c17
; PURECAP-NEXT:    cmove $c3, $c1
;
; HYBRID-LABEL: test:
; HYBRID:       # %bb.0: # %entry
; HYBRID-NEXT:    cfromptr $c1, $c4, $4
...
; HYBRID:       # %bb.0: # %entry
; HYBRID-NEXT:    cgetnull $c1
; HYBRID-NEXT:    cfromptr $c1, $c1, $4
; HYBRID-NEXT:    csc $c1, $zero, 0($c3)
; HYBRID-NEXT:    jr $ra
; HYBRID-NEXT:    cmove $c3, $c1
